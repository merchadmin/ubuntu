...
(function (window, document, $) {
  ...
  function setLayout(currentLocalStorageLayout) {
    var navLinkStyle = $('.nav-link-style'),
      ...
      var switchToLayout = currentLocalStorageLayout;
    ...
    if (switchToLayout === 'dark-layout') {
      ...
      $('#logo').removeClass('logo').addClass('logo-dark');
      $('#logoSmall').removeClass('logoSmall').addClass('logoSmall-dark');
      ...
      mainMenu.removeClass('menu-dark').addClass('menu-light');
      navbar.removeClass('navbar-dark').addClass('navbar-light');
      $('#logo').removeClass('logo-dark').addClass('logo');
      $('#logoSmall').removeClass('logoSmall-dark').addClass('logoSmall');
      navLinkStyle.find('.ficon').replaceWith(feather.icons['moon'].toSvg({ class: 'ficon' }));
    }
  ...
  $('.nav-link-style').on('click', function () {
    $.ajax({
        type: 'GET',
        url: "/change_theme_layout",
        success: function(res){
          if(res.success){
            setLayout(res.current_layout);
          }
        }
    });
  });
